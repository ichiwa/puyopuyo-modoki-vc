========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : puyo1
========================================================================


AppWizard が生成した puyo1 には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには puyo1 を構成している各ファイルの概要説明が含まれています。
...
puyo1.h
    ...
    みます） をインクルードし、また CPuyo1App アプリケーションクラスを宣
    言します。

puyo1.cpp
    このファイルは CPuyo1App アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\puyo1.ico
    ...
    ルです。このアイコンはリソース ファイル puyo1.rc によってインクルード
    されます。
...
puyo1Doc.h, puyo1Doc.cpp - ドキュメント
    これらのファイルは CPuyo1Doc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CPuyo1Doc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

puyo1View.h, puyo1View.cpp - ビュー
    これらのファイルは CPuyo1View クラスを含みます。
    CPuyo1View オブジェクトは CPuyo1Doc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) puyo1.pch 
